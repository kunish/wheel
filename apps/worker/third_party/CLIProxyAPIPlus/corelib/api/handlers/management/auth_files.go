...
import (
	...
	"github.com/kunish/wheel/apps/worker/third_party/CLIProxyAPIPlus/corelib/auth/antigravity"
	"github.com/kunish/wheel/apps/worker/third_party/CLIProxyAPIPlus/corelib/auth/claude"
	"github.com/kunish/wheel/apps/worker/third_party/CLIProxyAPIPlus/corelib/auth/codex"
	"github.com/kunish/wheel/apps/worker/third_party/CLIProxyAPIPlus/corelib/auth/copilot"
	geminiAuth "github.com/kunish/wheel/apps/worker/third_party/CLIProxyAPIPlus/corelib/auth/gemini"
	iflowauth "github.com/kunish/wheel/apps/worker/third_party/CLIProxyAPIPlus/corelib/auth/iflow"
	"github.com/kunish/wheel/apps/worker/third_party/CLIProxyAPIPlus/corelib/auth/kilo"
	"github.com/kunish/wheel/apps/worker/third_party/CLIProxyAPIPlus/corelib/auth/kimi"
	kiroauth "github.com/kunish/wheel/apps/worker/third_party/CLIProxyAPIPlus/corelib/auth/kiro"
	"github.com/kunish/wheel/apps/worker/third_party/CLIProxyAPIPlus/corelib/auth/qwen"
	"github.com/kunish/wheel/apps/worker/third_party/CLIProxyAPIPlus/corelib/interfaces"
	"github.com/kunish/wheel/apps/worker/third_party/CLIProxyAPIPlus/corelib/misc"
	"github.com/kunish/wheel/apps/worker/third_party/CLIProxyAPIPlus/corelib/registry"
	"github.com/kunish/wheel/apps/worker/third_party/CLIProxyAPIPlus/corelib/util"
...
// GeminiSetupFunc returns a function that performs GCP project onboarding for Gemini CLI.
// This is an exported wrapper around the unexported performGeminiCLISetup function,
// allowing first-party code (via sdk/cliproxy) to invoke GCP setup without duplicating logic.
func GeminiSetupFunc() func(ctx context.Context, httpClient *http.Client, storage *geminiAuth.GeminiTokenStorage, requestedProject string) error {
	return performGeminiCLISetup
}
