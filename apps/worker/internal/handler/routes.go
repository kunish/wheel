...
func (h *Handler) RegisterRoutes(r *gin.Engine) {
	...
	admin.PATCH("/channel/:id/codex/auth-files/status/batch", h.PatchCodexAuthFileStatusBatch)
	admin.DELETE("/channel/:id/codex/auth-files", h.DeleteCodexAuthFile)
	admin.POST("/channel/:id/codex/auth-files/delete/batch", h.DeleteCodexAuthFileBatch)
	...
	admin.PATCH("/channel/:id/copilot/auth-files/status/batch", h.PatchCodexAuthFileStatusBatch)
	admin.DELETE("/channel/:id/copilot/auth-files", h.DeleteCodexAuthFile)
	admin.POST("/channel/:id/copilot/auth-files/delete/batch", h.DeleteCodexAuthFileBatch)
