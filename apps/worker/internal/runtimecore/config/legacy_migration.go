...
// legacyConfigData holds deprecated top-level configuration keys that have been
// superseded by nested structures. It is used during startup to detect and
...
// legacyOpenAICompatibility mirrors the old openai-compatibility schema that
// carried plain string api-keys instead of the current structured entries.
