  ...
  return (
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        className={cn(
          "bg-background data-[state=open]:animate-in data-[state=closed]:animate-out ease-spring fixed z-50 flex flex-col gap-4 overflow-hidden p-6 shadow-2xl transition data-[state=closed]:duration-300 data-[state=open]:duration-500",
          side === "right" &&
