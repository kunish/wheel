...
- [ ] 3.2 Write unit tests for `listLogs` DAL — test keyword filtering, channelId filter, time range filter, combined filters, empty results
...
- [ ] 6.3 Add client-side column sorting for Latency, Cost, Input Tokens, Output Tokens — click header toggles asc/desc, show arrow indicator
...
- [ ] 7.3 Add in-content search input in Request/Response tabs — highlight matches, show match count
...
- [ ] 9.2 Write unit tests for debounce search hook — test 300ms debounce, rapid typing, clear behavior
- [ ] 9.3 Write unit tests for client-side column sorting — test ascending/descending toggle, switching columns, stable sort
...
- [ ] 9.6 Write unit tests for in-content search highlighting — test match counting, keyword highlighting, no matches case
